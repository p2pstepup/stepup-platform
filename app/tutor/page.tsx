...
export default function TutorDashboard() {
  ...
  const tabs = ['overview', 'students', 'notifications', 'meetings', 'announcements']
        ...
        {activeTab === 'students' && (
          <div>
            <div style={{marginBottom: 24}}>
              ...
              <div style={{fontSize: 14, color: '#8a7d6a', marginTop: 5}}>{students.length} students enrolled in May 2026 cohort</div>
            </div>
            ...
            {students.length === 0 ? (
              <div style={{background: 'white', border: '0.5px solid #e8dfc8', borderRadius: 12, padding: '40px', textAlign: 'center'}}>
                ...
                <div style={{fontSize: 14, color: '#8a7d6a', marginBottom: 20}}>Students will appear here once they create their accounts. Share the signup link with your cohort.</div>
                <div style={{background: '#f7f4ee', border: '0.5px solid #e8dfc8', borderRadius: 8, padding: '12px 16px', fontSize: 13, color: '#0d2340', fontFamily: 'monospace'}}>
                  stepup-platform.vercel.app
                </div>
              </div>
            ) : (
                  ...
                  <tbody>
                    {students.map((s, i) => (
                      <tr key={s.id} style={{borderBottom: i < students.length-1 ? '0.5px solid #f5f0e8' : 'none'}}>
                        ...
                        <td style={{padding: '14px 16px'}}>
                          <span style={{fontSize: 11, padding: '3px 10px', borderRadius: 10, background: '#f0f7f2', color: '#2d6a4f', fontWeight: 500}}>Active</span>
                        </td>
                      </tr>
                    ))}
                  </tbody>
            ...
            <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20}}>
              <div style={{background: 'white', border: '0.5px solid #e8dfc8', borderRadius: 12, padding: '20px 24px'}}>
                ...
                <div style={{marginBottom: 14}}>
                  ...
                  <select value={notifForm.student_id} onChange={e => setNotifForm({...notifForm, student_id: e.target.value})}
                    ...
                    {students.map(s => <option key={s.id} value={s.id}>{s.full_name || s.email.split('@')[0]}</option>)}
                  </select>
                </div>
                ...
                <div style={{marginBottom: 14}}>
                  ...
                  <select value={notifForm.type} onChange={e => setNotifForm({...notifForm, type: e.target.value})}
                    style={{width: '100%', height: 42, borderRadius: 8, border: '1px solid #e8dfc8', background: 'white', fontFamily: 'Sora, sans-serif', fontSize: 14, padding: '0 12px', color: '#1a1008', outline: 'none'}}>
                    {['general', 'assignment', 'exam', 'announcement', 'feedback', 'meeting'].map(t => (
                ...
                <div style={{marginBottom: 20}}>
                  <label style={{fontSize: 12, fontWeight: 500, color: '#5c4f35', display: 'block', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.05em'}}>Link (optional)</label>
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: 14}}>
                <div style={{background: '#0d2340', borderRadius: 12, padding: '20px 22px'}}>
                  <div style={{fontSize: 13, textTransform: 'uppercase', letterSpacing: '0.07em', color: '#c9a84c', marginBottom: 14}}>Quick notification templates</div>
                  {[
        ...
        {activeTab === 'meetings' && (
          <div>
            <div style={{marginBottom: 24}}>
              ...
              <div style={{fontSize: 14, color: '#8a7d6a', marginTop: 5}}>Notes appear automatically on the student's Mentor Meetings page</div>
            </div>
            ...
            <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20}}>
              <div style={{background: 'white', border: '0.5px solid #e8dfc8', borderRadius: 12, padding: '20px 24px'}}>
                ...
                <div style={{marginBottom: 14}}>
                  ...
                  <textarea value={meetingForm.action_items} onChange={e => setMeetingForm({...meetingForm, action_items: e.target.value})}
                    placeholder="What does the student need to do before the next meeting?"
                    rows={3}
                    style={{width: '100%', borderRadius: 8, border: '1px solid #e8dfc8', background: 'white', fontFamily: 'Sora, sans-serif', fontSize: 14, padding: '10px 12px', color: '#1a1008', outline: 'none', boxSizing: 'border-box', resize: 'none'}}/>
                </div>
              ...
              <div style={{background: '#0d2340', borderRadius: 12, padding: '20px 22px', height: 'fit-content'}}>
                ...
                {[
                  ...
                  'Fill in the meeting date, notes and action items',
        ...
        {activeTab === 'announcements' && (
          <div>
            <div style={{marginBottom: 24}}>
              ...
              <div style={{fontSize: 14, color: '#8a7d6a', marginTop: 5}}>Post program-wide announcements visible to all students on their dashboard</div>
            </div>
